...
public class Karaoke_Setting_Hook {
    ...
    Karaoke_Setting_Hook(ClassLoader mclassLoader) throws JSONException {

        classLoader = mclassLoader;
        this.adapter = new Adapter( "Setting" );
    }
    ...
    public void init() {
        try {
            ...
            String View_Field = adapter.getString( "View_Field" );
            XposedHelpers.findAndHookMethod( View_Class,
                    ...
                    new XC_MethodHook() {
                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                            ...
                            Field BField = XposedHelpers.findField( param.thisObject.getClass(), View_Field );
            ...
            LogUtil.e( "karorkefz", "设置处理出错:" + e.getMessage() );
        }
    }
}